...
PROMPT_INJECTION_PATTERNS = [
    ...
    r"system\s+prompt",
    r"reveal\s+(your\s+)?(system\s+)?(prompt|data|instructions|rules|memory|architecture)",
    r"show\s+(your\s+)?(system\s+)?(prompt|data|instructions|rules|memory|architecture)",
    r"tell\s+me\s+(your\s+)?(system\s+)?(prompt|instructions|rules|data)",
    r"what\s+are\s+your\s+(internal\s+)?(instructions|rules|prompts|system\s+instructions)",
