...
export default function SettingsModal({
  ...
  useEffect(() => {
    ...
    const savedModel = localStorage.getItem('pixlexpert_model') || 'gemini-2.5-flash';
              ...
              <div className="space-y-6">
                <div>
                  ...
                  <div className="grid grid-cols-1 sm:grid-cols-2 gap-3">
                    {[
                      { id: 'gemini-2.5-flash', name: 'Gemini 2.5 Flash (Recommended)', desc: 'Next-gen reasoning, lightning speed & multi-agent execution.', badge: 'Default' },
                      { id: 'gemini-2.5-pro', name: 'Gemini 2.5 Pro', desc: '1M+ context window for large codebase refactoring.', badge: 'Deep Thinking' },
                      { id: 'gemini-2.5-flash-lite', name: 'Gemini 2.5 Flash Lite', desc: 'Ultra-fast lightweight reasoning engine.', badge: 'Fast' },
                      { id: 'gemini-3.6-flash', name: 'Gemini 3.6 Flash', desc: 'Complex multi-agent engine & tools.', badge: 'Power' }
                    ].map((m) => (
                      <div
                        key={m.id}
